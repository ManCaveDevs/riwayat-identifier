  ...
  en: {
    ...
    docs: {
      ...
      about: {
        ...
        levelQiraah: "Qira'ah (reading)",
        levelQiraahDesc: "The method of recitation named after one of the 10 canonical Imams (readers). Each reader's approach was agreed upon by their students.",
        levelRiwayah: "Riwayah (narration)",
        levelRiwayahDesc: "A specific transmission from one of the reader's two primary narrators (ruwat). This is what our tool identifies.",
        levelTariq: "Tariq (path)",
